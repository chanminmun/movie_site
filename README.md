...
Cloud-based Movie Review Web Service
...
Authentication with Django Allauth (Google OAuth)
...
AWS S3 – media storage (user-uploaded images)
...
AWS credentials handled via environment variables or IAM role
...
Static and media files can be served via S3
